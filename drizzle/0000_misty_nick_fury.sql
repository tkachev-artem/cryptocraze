...
INSERT INTO "task_templates" ("template_id", "task_type", "title", "description", "reward_type", "reward_amount", "progress_total", "icon", "category", "rarity", "expires_in_hours") VALUES
('video_wheel', 'video_wheel', 'tasks.videoWheel.title', 'tasks.videoWheel.description', 'wheel', 'random', 1, '/trials/video.svg', 'video', 'common', 12),
('video_money', 'video_money', 'tasks.videoMoney.title', 'tasks.videoMoney.description', 'money', '1000', 1, '/trials/video.svg', 'video', 'common', 12),
('video_coins', 'video_coins', 'tasks.videoCoins.title', 'tasks.videoCoins.description', 'coins', '30', 1, '/trials/video.svg', 'video', 'common', 12),
('video_energy', 'video_energy', 'tasks.videoEnergy.title', 'tasks.videoEnergy.description', 'energy', '18', 1, '/trials/video.svg', 'video', 'common', 12),
('video_mega', 'video_mega', 'tasks.videoMega.title', 'tasks.videoMega.description', 'mixed', '12_energy_1500_money', 1, '/trials/video.svg', 'video', 'rare', 12),
('daily_bonus', 'daily_bonus', 'tasks.dailyBonus.title', 'tasks.dailyBonus.description', 'money', '750', 1, '/trials/energy.svg', 'daily', 'common', 24),
('daily_trader', 'daily_trader', 'tasks.dailyTrader.title', 'tasks.dailyTrader.description', 'coins', '40', 1, '/trials/trade.svg', 'daily', 'common', 24),
('trade_first_profit', 'trade_first_profit', 'tasks.tradeFirstProfit.title', 'tasks.tradeFirstProfit.description', 'coins', '25', 100, '/trials/trade.svg', 'trade', 'common', 24),
('trade_lucky', 'trade_lucky', 'tasks.tradeLucky.title', 'tasks.tradeLucky.description', 'mixed', '8_energy_800_money', 500, '/trials/trade.svg', 'trade', 'rare', 24),
('trade_close', 'trade_close', 'tasks.tradeClose.title', 'tasks.tradeClose.description', 'money', '600', 1, '/trials/trade.svg', 'trade', 'common', 24),
('trade_master', 'trade_master', 'tasks.tradeMaster.title', 'tasks.tradeMaster.description', 'mixed', '15_energy_2000_money', 1000, '/trials/trade.svg', 'trade', 'epic', 24),
('premium_login', 'premium_login', 'tasks.premiumLogin.title', 'tasks.premiumLogin.description', 'coins', '35', 1, '/trials/premium.svg', 'premium', 'rare', 24),
('premium_vip', 'premium_vip', 'tasks.premiumVip.title', 'tasks.premiumVip.description', 'mixed', '5_energy_20_coins', 1, '/trials/premium.svg', 'premium', 'rare', 24);--> statement-breakpoint
